...
- 📂 **5. [Generation Error](#generation-error)**

  - 📄 5.1. [Omission](#omission)
  - 📄 5.2. [Distortion](#distortion)
    - 🔸 5.2.1. [Conflation](#conflation)
    - 🔸 5.2.2. [Partially correct](#partially-correct)
  - 📄 5.3. [Fabrication](#fabrication)

- 📂 **6. [Other Error](#other-error)**
  - 📄 6.1. [Incomplete extraction](#incomplete-extraction)
  - 📄 6.2. [Dictionary error](#dictionary-error)
  - 📄 6.3. [Normalization error](#normalization-error)
...
**<a id="generation-error">📂 5. Generation Error</a>**

_Definition:_ Generation errors occur when an LLM-based model produces output that is incorrect in form or completeness due to the generative process — including failing to produce any output, misrepresenting a valid concept's attributes, partially capturing a concept, or fabricating content not present in the source text.

- 📄 **<a id="omission">5.1. Omission</a>**

  _Definition:_ The model fails entirely to capture an existing concept that is present in the text.
...
- 📄 **<a id="distortion">5.2. Distortion</a>**

  _Definition:_ The model misrepresents the temporal, certainty, or intensity aspect of a valid concept that is present in the text.
  ...
  - 🔸 **<a id="conflation">5.2.1. Conflation</a>**

    _Definition:_ Merging distinct concepts into one, resulting in a loss of nuance between similar concepts.

    _Example:_

    - The model tags "chronic confusion" as delirium, when it should be dementia

  - 🔸 **<a id="partially-correct">5.2.2. Partially correct</a>**

    _Definition:_ The model partially captures a concept but misses critical modifiers such as negation, severity, or temporal qualifiers.

    _Example (delirium):_

    - Model identifies concept but misses the negation
    - Text: "No signs of delirium observed"
    - Model: delirium (positive)

- 📄 **<a id="fabrication">5.3. Fabrication</a>**

  _Definition:_ The model generates a concept entirely absent from the source text, producing content based on learned associations rather than actual input.

  _Example (fall):_

  - Note: "Patient walked to the restroom unaided."
  - Model outputs: "Patient fell in the restroom"

**<a id="other-error">📂 6. Other Errors</a>**

- 📄 **<a id="incomplete-extraction">6.1. Incomplete extraction</a>**
...
- 📄 **<a id="dictionary-error">6.2. Dictionary error</a>**
...
- 📄 **<a id="normalization-error">6.3. Normalization error</a>**
